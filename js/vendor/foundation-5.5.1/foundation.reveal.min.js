    ...
    Foundation.libs.reveal = {
        ...
        events:function() {
            ...
            return t(this.scope).off(".reveal").on("click.fndtn.reveal", "[" + this.add_namespace("data-reveal-id") + "]:not([disabled])", function(n) {
                ...
                if (n.preventDefault(), !e.locked) {
                    var s = t("[" + e.attr_name() + "].open").data(e.attr_name(!0) + "-init") || e.settings, i = t(n.target)[0] === t("." + s.bg_class)[0];
                    if (i) {
        ...
        key_up_on:function() {
            ...
            return e.S("body").off("keyup.fndtn.reveal").on("keyup.fndtn.reveal", function(t) {
                var n = e.S("[" + e.attr_name() + "].open"), s = n.data(e.attr_name(!0) + "-init") || e.settings;
        ...
        open:function(n, s) {
            var i, a = this;
            n ? "undefined" != typeof n.selector ? i = a.S("#" + n.data(a.data_attr("reveal-id"))).first() :(i = a.S(this.scope), s = n) :i = a.S(this.scope);
            ...
            if (!i.hasClass("open")) {
                ...
                if ("undefined" == typeof i.data("css-top") && i.data("css-top", parseInt(i.css("top"), 10)).data("offset", this.cache_offset(i)), this.key_up_on(i), i.on("open.fndtn.reveal", function(e) {
                    "fndtn.reveal" !== e.namespace;
                }), i.on("open.fndtn.reveal").trigger("open.fndtn.reveal"), r.length < 1 && this.toggle_bg(i, !0), "string" == typeof s && (s = {
                    url:s
                }), "undefined" != typeof s && s.url) {
                    var d = "undefined" != typeof s.success ? s.success :null;
                    e.extend(s, {
                        success:function(t, n, s) {
                            ...
                            i.html(t), a.S(i).foundation("section", "reflow"), a.S(i).children().foundation(), r.length > 0 && (o.multiple_opened ? this.to_back(r) :this.hide(r, o.css.close)), a.show(i, o.css.open);
                        }
                    }), e.ajax(s);
                } else r.length > 0 && (o.multiple_opened ? this.to_back(r) :this.hide(r, o.css.close)), this.show(i, o.css.open);
            }
            a.S(t).trigger("resize");
        },
        close:function(t) {
            var t = t && t.length ? t :this.S(this.scope), n = this.S("[" + this.attr_name() + "].open"), s = t.data(this.attr_name(!0) + "-init") || this.settings;
            n.length > 0 && (this.locked = !0, this.key_up_off(t), t.trigger("close").trigger("close.fndtn.reveal"), (s.multiple_opened && 1 === n.length || !s.multiple_opened || t.length > 1) && (this.toggle_bg(t, !1), this.to_front(t)), s.multiple_opened ? (this.hide(t, s.css.close, s), this.to_front(e(e.makeArray(n).reverse()[1]))) :this.hide(n, s.css.close, s));
        },
        ...
        toggle_bg:function(t, n) {
            ...
            n != i && ((n == s ? i :!n) ? this.hide(this.settings.bg) :this.show(this.settings.bg));
        },
        show:function(n, s) {
            if (s) {
                var a = n.data(this.attr_name(!0) + "-init") || this.settings, o = a.root_element;
                if (0 === n.parent(o).length) {
                    var r = n.wrap('<div style="display: none;" />').parent();
                ...
                if (d.animate || (this.locked = !1), d.pop) {
                    ...
                    return setTimeout(function() {
                        return n.css(s).animate(l, a.animation_speed, "linear", function() {
                            this.locked = !1, n.trigger("opened").trigger("opened.fndtn.reveal");
                        }.bind(this)).addClass("open");
                    }.bind(this), a.animation_speed / 2);
                }
                if (d.fade) {
                    s.top = e(t).scrollTop() + n.data("css-top") + "px";
                    var l = {
                        opacity:1
                    };
                    return setTimeout(function() {
        ...
        hide:function(n, s) {
            if (s) {
                ...
                if (o.animate || (this.locked = !1), o.pop) {
                    ...
                    return setTimeout(function() {
                        return n.animate(r, a.animation_speed, "linear", function() {
                            this.locked = !1, n.css(s).trigger("closed").trigger("closed.fndtn.reveal");
                ...
                return n.hide().css(s).removeClass("open").trigger("closed").trigger("closed.fndtn.reveal");
            }
            var a = this.settings;
        ...
        close_video:function(t) {
            ...
            s.length > 0 && (s.attr("data-src", s[0].src), s.attr("src", s.attr("src")), n.hide());
        },
