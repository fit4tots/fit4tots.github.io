!function(t, e, i, s) {
    ...
    var a = function() {}, n = function(a, n) {
        ...
        f.slides = function() {
            ...
            g.wrap('<div class="' + n.container_class + '"></div>'), c = g.parent(), g.addClass(n.slides_container_class), n.stack_on_small && c.addClass(n.stack_on_small_class), n.navigation_arrows && (c.append(t('<a href="#"><span></span></a>').addClass(n.prev_class)), c.append(t('<a href="#"><span></span></a>').addClass(n.next_class))), n.timer && (u = t("<div>").addClass(n.timer_container_class), u.append("<span>"), u.append(t("<div>").addClass(n.timer_progress_class)), u.addClass(n.timer_paused_class), 
            c.append(u)), n.slide_number && (d = t("<div>").addClass(n.slide_number_class), d.append("<span></span> " + n.slide_number_text + " <span></span>"), c.append(d)), n.bullets && (_ = t("<ol>").addClass(n.bullets_container_class), c.append(_), _.wrap('<div class="orbit-bullets-container"></div>'), f.slides().each(function(e) {
            ...
            var l = function() {
                ...
                g.outerHeight() != o.outerHeight() && n.variable_height ? g.animate({
            ...
            o.outerHeight() > g.outerHeight() && n.variable_height ? g.animate({
                height:o.outerHeight()
            }, 250, "linear", c) :c();
        }, f.next = function(t) {
            ...
            var e = t(f.slides().get(h)), i = e.outerHeight();
            ...
            }), t(i).on("click", "[data-orbit-link]", f.link_custom), t(e).on("load resize", f.compute_dimensions), Foundation.utils.image_loaded(this.slides().children("img"), f.compute_dimensions), Foundation.utils.image_loaded(this.slides().children("img"), function() {
                c.prev("." + n.preloader_class).css("display", "none"), f.update_slide_number(0), f.update_active_link(0), g.trigger("ready.fndtn.orbit");
            });
        }, f.init();
    }, r = function(t, e, i) {
        ...
        this.update_progress = function(t) {
            ...
            return t.hasClass(e.timer_paused_class) ? (l = -1 === l ? r :l, t.removeClass(e.timer_paused_class), s = new Date().getTime(), o.animate({
                width:"100%"
        ...
        n[a] = "0%", this.next = function(t, e, s) {
            t.animate({
                marginLeft:"-100%"
            }, i), e.animate(n, i, function() {
                t.css(a, "100%"), s();
            });
        }, this.prev = function(t, e, s) {
            t.animate({
                marginLeft:"100%"
            }, i), e.css(a, "-100%"), e.animate(n, i, function() {
                t.css(a, "100%"), s();
            });
        };
    }, l = function(e) {
