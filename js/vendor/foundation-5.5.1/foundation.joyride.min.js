!function(t, s, i, e) {
    ...
    Foundation.libs.joyride = {
        ...
        init:function(s, i, e) {
            Foundation.inherit(this, "throttle random_str"), this.settings = this.settings || t.extend({}, this.defaults, e || i), this.bindings(i, e);
        },
        go_next:function() {
        ...
        button_text:function(s) {
            return this.settings.tip_settings.next_button ? (s = t.trim(s) || "Next", s = t(this.settings.template.button).append(s)[0].outerHTML) :s = "", s;
        },
        prev_button_text:function(s, i) {
            return this.settings.tip_settings.prev_button ? (s = t.trim(s) || "Previous", s = 0 == i ? t(this.settings.template.prev_button).append(s).addClass("disabled")[0].outerHTML :t(this.settings.template.prev_button).append(s)[0].outerHTML) :s = "", s;
        },
        create:function(s) {
            this.settings.tip_settings = t.extend({}, this.settings, this.data_options(s.$li));
            var i = s.$li.attr(this.add_namespace("data-button")) || s.$li.attr(this.add_namespace("data-text")), e = s.$li.attr(this.add_namespace("data-button-prev")) || s.$li.attr(this.add_namespace("data-prev-text")), n = s.$li.attr("class"), o = t(this.tip_template({
                tip_class:n,
                index:s.index,
                button_text:i,
                prev_button_text:e,
        ...
        show:function(s, i) {
            var n = null;
            if (this.settings.$li === e || -1 === t.inArray(this.settings.$li.index(), this.settings.pause_after)) if (this.settings.paused ? this.settings.paused = !1 :this.set_li(s, i), this.settings.attempts = 0, this.settings.$li.length && this.settings.$target.length > 0) {
                if (s && (this.settings.pre_ride_callback(this.settings.$li.index(), this.settings.$next_tip), this.settings.modal && this.show_modal()), this.settings.pre_step_callback(this.settings.$li.index(), this.settings.$next_tip), this.settings.modal && this.settings.expose && this.expose(), this.settings.tip_settings = t.extend({}, this.settings, this.data_options(this.settings.$li)), this.settings.timer = parseInt(this.settings.timer, 10), this.settings.tip_settings.tip_location_pattern = this.settings.tip_location_patterns[this.settings.tip_settings.tip_location], 
            ...
            } else this.settings.$li && this.settings.$target.length < 1 ? this.show(s, i) :this.end(); else this.settings.paused = !0;
        },
        is_phone:function() {
        ...
        set_li:function(t, s) {
            t ? (this.settings.$li = this.settings.$tip_content.eq(this.settings.start_offset), this.set_next_tip(), this.settings.$current_tip = this.settings.$next_tip) :(this.settings.$li = s ? this.settings.$li.prev() :this.settings.$li.next(), this.set_next_tip()), this.set_target();
        },
        ...
        scroll_to:function() {
            var i, e;
            i = t(s).height() / 2, e = Math.ceil(this.settings.$target.offset().top - i + this.settings.$next_tip.outerHeight()), 0 != e && t("html, body").stop().animate({
                scrollTop:e
        ...
        pos_default:function(t) {
            var s = this.settings.$next_tip.find(".joyride-nub"), i = Math.ceil(s.outerWidth() / 2), e = Math.ceil(s.outerHeight() / 2), n = t || !1;
            if (n && (this.settings.$next_tip.css("visibility", "hidden"), this.settings.$next_tip.show()), /body/i.test(this.settings.$target.selector)) this.settings.$li.length && this.pos_modal(s); else {
                var o = this.settings.tip_settings.tipAdjustmentY ? parseInt(this.settings.tip_settings.tipAdjustmentY) :0, h = this.settings.tip_settings.tipAdjustmentX ? parseInt(this.settings.tip_settings.tipAdjustmentX) :0;
                this.bottom() ? (this.settings.$next_tip.css(this.rtl ? {
                    top:this.settings.$target.offset().top + e + this.settings.$target.outerHeight() + o,
                    ...
                    top:this.settings.$target.offset().top - this.settings.$next_tip.outerHeight() - e + o,
                    ...
                    left:this.settings.$target.outerWidth() + this.settings.$target.offset().left + i + h
                }), this.nub_position(s, this.settings.tip_settings.nub_position, "left")) :this.left() && (this.settings.$next_tip.css({
                    top:this.settings.$target.offset().top + o,
                    left:this.settings.$target.offset().left - this.settings.$next_tip.outerWidth() - i + h
        ...
        pos_phone:function(s) {
            ...
            n.removeClass("bottom").removeClass("top").removeClass("right").removeClass("left"), h && (this.settings.$next_tip.css("visibility", "hidden"), this.settings.$next_tip.show()), /body/i.test(this.settings.$target.selector) ? this.settings.$li.length && this.pos_modal(n) :this.top() ? (this.settings.$next_tip.offset({
                top:this.settings.$target.offset().top - i - o
            }), n.addClass("bottom")) :(this.settings.$next_tip.offset({
                top:this.settings.$target.offset().top + e + o
            }), n.addClass("top")), h && (this.settings.$next_tip.hide(), this.settings.$next_tip.css("visibility", "visible"));
        },
        ...
        show_modal:function() {
            if (!this.settings.$next_tip.data("closed")) {
                ...
                if (s.length < 1) {
                    var s = t(this.settings.template.modal);
                    s.appendTo("body");
                }
                /pop/i.test(this.settings.tip_animation) ? s.show() :s.fadeIn(this.settings.tip_animation_fade_speed);
            }
        },
        expose:function() {
            ...
            return n.length < 1 ? (s.console && console.error("element not valid", n), !1) :(i = t(this.settings.template.expose), this.settings.$body.append(i), i.css({
                top:n.offset().top,
                left:n.offset().left,
                width:n.outerWidth(!0),
                height:n.outerHeight(!0)
            }), e = t(this.settings.template.expose_cover), o = {
                zIndex:n.css("z-index"),
                position:n.css("position")
            }, h = null == n.attr("class") ? "" :n.attr("class"), n.css("z-index", parseInt(i.css("z-index")) + 1), "static" == o.position && n.css("position", "relative"), n.data("expose-css", o), n.data("orig-class", h), n.attr("class", h + " " + this.settings.expose_add_class), e.css({
                top:n.offset().top,
                left:n.offset().left,
                width:n.outerWidth(!0),
                height:n.outerHeight(!0)
            }), this.settings.modal && this.show_modal(), this.settings.$body.append(e), i.addClass(a), e.addClass(a), n.data("expose", a), this.settings.post_expose_callback(this.settings.$li.index(), this.settings.$next_tip, n), void this.add_exposed(n));
        },
        un_expose:function() {
            var i, e, n, o, h, a = !1;
            ...
            return e.length < 1 ? (s.console && console.error("element not valid", e), !1) :(i = e.data("expose"), n = t("." + i), arguments.length > 1 && (a = arguments[1]), a === !0 ? t(".joyride-expose-wrapper,.joyride-expose-cover").remove() :n.remove(), o = e.data("expose-css"), "auto" == o.zIndex ? e.css("z-index", "") :e.css("z-index", o.zIndex), o.position != e.css("position") && ("static" == o.position ? e.css("position", "") :e.css("position", o.position)), h = e.data("orig-class"), e.attr("class", h), 
            e.removeData("orig-classes"), e.removeData("expose"), e.removeData("expose-z-index"), void this.remove_exposed(e));
        },
        ...
        remove_exposed:function(s) {
            var i, e;
            for (s instanceof t ? i = s[0] :"string" == typeof s && (i = s), this.settings.exposed = this.settings.exposed || [], e = this.settings.exposed.length; e--; ) if (this.settings.exposed[e] == i) return void this.settings.exposed.splice(e, 1);
        },
        center:function() {
            var i = t(s);
